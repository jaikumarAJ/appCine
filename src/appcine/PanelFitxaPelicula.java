...
public class PanelFitxaPelicula extends javax.swing.JPanel {
   ...
   /**
    * Crea un nou PanelFitxaPelicula: constructor buid
    * @param principal : instancia de @PantallaInicial
    */
    ...
    /**
     * Setea la pel·lícula que s'ha de mostrar al panel
     * @param peli : Objecte Pelicula que es mostra
     */
    ...
    /**
     * Seteja les dimensions i posicions del Panel.
     * @param x : posició x
     * @param y : posició y
     * @param width : ample del panel
    ...
    /**
     * Sobreescriu el métode setVisible perque, en el moment de que s'hagi de fer visible, carregui les dades de la pel·lícula
     * @param aFlag : boolean si s'ha de fer visible o invisible
     */
    ...
    /**
     * Carrega el panel pel·lícules amb l'info de la pel·lícula corresponent.
     * @param index nombre de l'index que ocupa dins l'ArrayList @pelicules
     */
